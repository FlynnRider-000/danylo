                    ...
                    <div class="dan-a dan-card">
                      <div class="dan-table p-15-15">
                        <ul>
                          ...
                          <li>
                            <h6>City:</h6><span>Brovary</span>
                          </li>

                          <li>
                            <h6>Street:</h6><span>57 Korolenko St</span>
                          </li>
                        </ul>
                      </div>
                    </div>
                  ...
                  <div class="col-lg-4">
                    ...
                    <div class="dan-a dan-card">
                      <div class="dan-table p-15-15">
                        <ul>
                          <li>
                            <h6>Email:</h6><span>coronarider01@gmail.com</span>
                          </li>
                          <li>
                            <h6>GitHub:</h6><span>FlynnRider-000</span>
                          </li>
                          <li>
                            <h6>Skype:</h6><span>live:.cid.9fcd662724741b13</span>
                          </li>
                        </ul>
                      </div>
                    </div>
